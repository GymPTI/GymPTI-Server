package kr.hs.dgsw.GymPTI.global.jwt;

import io.jsonwebtoken.*;
import io.jsonwebtoken.security.Keys;
import kr.hs.dgsw.GymPTI.global.config.AppProperty;
...
public class JwtUtil {
    ...
    public String checkTokenType(TokenType tokenType) {
        return switch (tokenType) {
            case ACCESS -> appProperty.getAccessSecretKey();
            case REFRESH -> appProperty.getRefreshSecretKey();
        };
    }
