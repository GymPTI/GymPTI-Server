...
import kr.hs.dgsw.GymPTI.common.error.ErrorResponseEntity;
...
public class GlobalExceptionHandler {
    ...
    protected ResponseEntity handleCustomException(CustomException e) {
        log.warn(e.getErrorCode().toString() + ": " + e.getErrorCode().getMessage());
    ...
    protected ResponseEntity handleServletRequestBindingException(ServletRequestBindingException e) {
        return ResponseEntity
                .status(401)
                .body(ErrorResponseEntity.builder()
